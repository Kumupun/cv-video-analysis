...
class FFmpegVideoDecoder:
    ...
    def _effective_chunking(self) -> tuple[int, int]:
        ...
        # At most one quarter of the tensor is historical context. The rest is
        # guaranteed to advance the non-overlapping valid frame range.
        overlap_frames = min(
...
# Transitional alias for integrations importing the previous class name.
